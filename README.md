...
```sh
  cd my-folder
  git clone https://github.com/MarwanDev/database_from_diagram.git
```
...
- LinkedIn: [marwan-abdelsattar](https://linkedin.com/in/marwan-abdelsattar)

👤 **Aimable**

- GitHub: [@BANCUNGUYE66](https://github.com/BANCUNGUYE66)
- LinkedIn: [aimable-bancunguye-aba703143](https://linkedin.com/in/aimable-bancunguye-aba703143)
